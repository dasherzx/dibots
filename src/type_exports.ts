...
/**
 * This file re-exports only those EagleEye types that we'd like plugins to have access to.
 *
 * Generated types are referenced from the `types` field of the EagleEye's. `package.json`, so
 * that plugins can just reference EagleEye root folder to access all required types.
 *
