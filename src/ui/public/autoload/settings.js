 ...
 * - dateFormat:tz (meaning the EagleEye time zone will be used in your plugin)
 * - dateFormat:dow (meaning the EagleEye configured start of the week will be used in your plugin)
 */
