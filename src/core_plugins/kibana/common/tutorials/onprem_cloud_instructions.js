...
To create a cluster, in Elastic Cloud console:\n\
 ...
 5. Go to the new Cloud EagleEye instance and follow the EagleEye Home instructions',
    values: {
...
export const createTrycloudOption2 = () => ({
  title: i18n.translate('kbn.common.tutorials.premCloudInstructions.option2.title', {
    defaultMessage: 'Option 2: Connect local EagleEye to a Cloud instance',
  }),
  textPre: i18n.translate('kbn.common.tutorials.premCloudInstructions.option2.textPre', {
    defaultMessage: 'If you are running this EagleEye instance against a hosted Elasticsearch instance, \
